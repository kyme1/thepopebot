...
import { open-ohcodeDb, dataDir, PROJECT_ROOT } from '../paths.js';
...
export function getDb() {
  if (!_db) {
    ...
    const sqlite = new Database(open-ohcodeDb);
...
export function initDatabase() {
  ...
  const migrationsFolder = path.join(PROJECT_ROOT, 'node_modules', 'open-ohcode', 'drizzle');
